...
fruits.forEach(fruit => {
    let small = fruit.toLowerCase()
    console.log(small)
});
// Convert all fruits name into lowercase and store in new array named lowercaseFruits
fruits.forEach(fruit => {
    let lowercaseFruits = fruit.toUpperCase()
    console.log(lowercaseFruits);
});
// Convert all fruits name into uppercase and store in new array named uppercaseFruits
fruits.forEach(fruit => {
    let uppercaseFruits = fruit.toUpperCase()
...
let newFlat = console.log(numbersThree.flat(Infinity));
console.log(newFlat);
...
let Num = numbersThree;
let doubleNumbers = Num.flat(Infinity);
console.log(doubleNumbers);
doubleNumbers.map(num =>{
    console.log(num * 2);
})
// Create a new variable named tripleNumbers that store the numberThree array (each element should be multiplied by 3). Use map
let tripleNumbers = doubleNumbers;
tripleNumbers.map(num =>{
    console.log(num * 3);
})
// Create a new variable named halfNumbers that store the numberThree array (each element should be divided by 2). Use map
let halfNumbers = tripleNumbers;
halfNumbers.map(num =>{
    console.log(num / 2);
})
